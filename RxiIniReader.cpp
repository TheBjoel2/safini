...
const char* RxiIniReader::read(const std::string_view name, const std::string_view section) const noexcept
{
    if(section.empty())
...
std::optional<const std::string_view> RxiIniReader::get(const std::string_view name, const std::string_view section) const noexcept
{
